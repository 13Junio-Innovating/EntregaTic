        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.error) {
                    ...
                    th.innerHTML = "Número da Entrega";
                    tr.appendChild(th);

                    th = document.createElement("th");
                    th.setAttribute("scope", "col");
                    th.innerHTML = "Colaborador";
                    tr.appendChild(th);
                    ...
                    th = document.createElement("th");
                    th.setAttribute("scope", "col");
                    th.innerHTML = "Data da Entrega";
                    tr.appendChild(th);

                    th = document.createElement("th");
                    th.setAttribute("scope", "col");
                    th.innerHTML = "ID Controle TIC";
                    tr.appendChild(th);
                    ...
                    for (let i = 0; i < response.length; i++) {
                        ...
                        td = document.createElement('td')
                        td.innerHTML = salesObj.product_id_controletic;
                        tr.appendChild(td);
