        ...
        <div class="offcanvas-body">
            <div>
                <ul class="menu-container">
                    ...
                    if ($user_logged->tipo_permissao == "cadastro" || $user_logged->tipo_permissao == "administrador") { ?>
                        <div class="menu-box dropbottom">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                <li onclick="window.location.href='cadastro-colaborador';"><a class="dropdown-item" href="cadastro-colaborador"><i class="fa-solid fa-user-plus menu-icon"></i> Colaborador</a></li>
                    ...
                    <!-- restrições entrega -->
                    <?php
                    if ($user_logged->tipo_permissao == "entrega" || $user_logged->tipo_permissao == "administrador") { ?>
                        <li class="menu-box" onclick="window.location.href='historico-de-entregas';">
                    ...
                    <?php
                    if ($user_logged->tipo_permissao == "entrega" || $user_logged->tipo_permissao == "administrador") { ?>
                        <li class="menu-box" onclick="window.location.href='entregas';">
                    ...
                    <?php
                    if ($user_logged->tipo_permissao == "entrega" || $user_logged->tipo_permissao == "administrador") { ?>
                        <li class="menu-box" onclick="window.location.href='devolucao';">
