                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <form action="#" method="post" id="formAddNewClient">
                                ...
                                <div class="row">
                                    <div class="form-floating col-md-4">
                                        <input type="text" id="celula" name="celula" title="Celula" class="form-control" placeholder="Celula" required>
                                        <label for="celula" class="required-field-label" title="Celula">Célula</label>
                                    </div>
                                    <div class="form-floating col-md-4">
                                        <input type="text" id="predio" name="predio" title="Predio" class="form-control" placeholder="Predio" required>
                                        <label for="predio" class="required-field-label" title="Prédio">Prédio/Vila</label>
                                    </div>
                                    <div class="form-floating col-md-4">
                                        <input type="text" id="cargo" name="cargo" title="Cargo" class="form-control" placeholder="Cargo" required>
                                        <label for="cargo" class="required-field-label" title="Cargo">Cargo</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <select id="empresa" name="empresa" class="form-select form-control" title="Empresa" required>
                                            <option selected="">Empresa</option>
                                            <option value="COSTAO">COSTAO</option>
                                            <option value="CONDOMINIO">CONDOMINIO</option>
                                            <option value="ECAP">ECAP</option>
                                            <option value="REAL STATE">REAL STATE</option>
                                            <option value="ESTALEIRINHO SPE">ESTALEIRINHO SPE</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mt-3">
