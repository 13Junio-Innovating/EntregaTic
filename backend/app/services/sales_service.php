...
class SalesSerivce
{
    ...
    public function registerSale()
    {
        ...
        $stmt->bindValue(':assinatura', $this->sale->__get('assinatura')); 
        $stmt->bindValue(':patrimonio', $this->sale->__get('patrimonio'));
        $stmt->bindValue(':itsm_ticket', $this->sale->__get('itsm_ticket'));
        $stmt->bindValue(':hostname', $this->sale->__get('hostname'));
        $stmt->execute();
