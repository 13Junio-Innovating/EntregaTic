...
if ($csrf_token != $_SESSION['csrf_token']) {
    ...
    if ($action === "report_client") {
        ...
        ';
            ...
            <div style="width: 100%; display: flex; align-items: center; justify-content: space-between;">
                <div style="width: 30%;">
                    <img src="/var/www/html/entregatic/app/assets/img/logo/logo_costao.png" width="120">
                </div>
                <div style="width: 100%; text-align: center;">
                    <div style="font-size: 14px; font-weight: bold;">Entregas TIC</div>
                    <div style="font-size: 12px;">https://www.costao.com.br/</div>
                    <br>
                    <div style="font-size: 12px; font-weight: bold;">Relatório de Colaboradores</div>
                </div>
            </div>
        ...
        if ($_GET["report_type"] === "pdf") {
            ...
            <div style="width: 100%; display: flex; align-items: center; justify-content: space-between;">
                ...
                <div style="width: 100%; text-align: center;">
                    ...
                    <div style="font-size: 12px;">https://www.costao.com.br/</div>
                    <br>
                    <div style="font-size: 12px; font-weight: bold;">Relatório de Produtos</div>
                </div>
            </div>
            <hr style="margin-top: 5px;">
        ...
        if ($_GET["report_type"] === "pdf") {
            ...
            <div style="width: 100%; display: flex; align-items: center; justify-content: space-between;">
                ...
                <div style="width: 100%; text-align: center;">
                    ...
                    <div style="font-size: 12px;">https://www.costao.com.br/</div>
                    <br>
                    <div style="font-size: 12px; font-weight: bold;">Relatório de Fornecedores</div>
                </div>
            </div>
            <hr style="margin-top: 5px;"> 
    ...
    if ($action === "report_sales") {
        if ($_GET["report_type"] === "pdf") {
            ...
            <div style="width: 100%; display: flex; align-items: center; justify-content: space-between;">
                ...
                <div style="width: 100%; text-align: center;">
                    ...
                    <div style="font-size: 12px;">https://www.costao.com.br/</div>
                    <br>
                    <div style="font-size: 12px; font-weight: bold;">Relatório de Entregas</div>
                </div>
            </div>
            <hr style="margin-top: 5px;">  
        ...
        ');
            ...
            $mpdf->WriteHTML($html);
            $mpdf->Output("relatorio_entregas.pdf", "I");
            exit();
            ob_end_flush(); //limpa o buffer e envia a saida para o navegador
        }
        ...
        if ($_GET["report_type"] === "excel") {
            ...
            //definicar cabeçalho das colunas
            $columns = ['Numero da Entrega', 'Colaborador', 'TIC', 'Produto', 'Quantidade', 'Custo Unitário', 'Data da Entrega'];
            $sheet->fromArray($columns, NULL, 'A1');
