...
if ($_SERVER["REQUEST_METHOD"] === "POST" && !empty($_POST)) {
    ...
    $product_id_doc_controletic = $new_product_values['id-controle-tic'];
    $product_type = $new_product_values['product-type'];
    $product_so = $new_product_values['product-so'];
    $product_cpu = $new_product_values['product-cpu'];
    $product_memory = $new_product_values['product-memory'];
    $product_imei = $new_product_values['product-imei'];
    $product_storage = $new_product_values['product-storage'];
    $product_email = $new_product_values['product-email'];
        ...
        if (isset($action) && $action === "add_product") {
            ...
            if ($result) {
                ...
                if (empty($img_product['name'])) {
                    ...
                    $model_product->__set('id_doc_controletic', $product_id_doc_controletic);
                    $model_product->__set('tipo_produto', $product_type);
                    $model_product->__set('so_produto', $product_so);
                    $model_product->__set('cpu_produto', $product_cpu);
                    $model_product->__set('memoria_produto', $product_memory);
                    $model_product->__set('imei_produto', $product_imei);
                    $model_product->__set('storage_produto', $product_storage);
                    $model_product->__set('email_produto', $product_email);
